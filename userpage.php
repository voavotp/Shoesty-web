        ...
        if ($result->num_rows > 0) {
            while ($shoe = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td><a href="../shoesty/php/deleteshoe.php?id=<?php echo ($shoe['ShoeID']); ?>" onclick="return confirm('Are you sure you want to delete this shoe?');"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0a0a0a"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></a></td>
                </tr>
                <?php
            }
        } else {
